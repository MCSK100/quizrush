...
<div className="qr-surface mx-auto mt-6 max-w-lg rounded-[24px] p-5 text-left text-sm"><b className="font-display text-ink">How a match works</b><ol className="mt-2 flex flex-col gap-1.5 font-medium text-muted"><li>1. Host picks category, questions & timer</li><li>2. Players join with a 5-letter code</li><li>3. Countdown → everyone answers together → live leaderboard</li></ol></div>
</div>);
}
