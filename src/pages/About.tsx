  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <div className="qr-surface mt-6 rounded-[24px] p-5 sm:p-6 text-[15px] font-medium leading-relaxed text-ink/80">
        <p>Quizlly is a fast-paced quiz arena. Play solo battles against the clock or race friends live in multiplayer rooms — every game deals a fresh set of AI-generated questions, so no two battles feel the same.</p>
        <p className="mt-3">Pick from 17 topics plus custom topics, choose English, Tamil, or both, and tune the difficulty, timer, and question type to your style.</p>
        <p className="mt-3">No sign-up needed. One tap and you are in the arena.</p>
      </div>
